...
//
// Remove FK constraint from cms page table
//
$installer->run("
alter table {$installer->getTable('cms_page')}
    drop foreign key FK_GOOGLE_AUTHORSHIP_ID;
");

//
// Add revised FK constraint to google_author_id column, references sfc_googleauthor (id)
//
